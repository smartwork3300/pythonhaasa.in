"""
Django settings for haasa project.
...
SECRET_KEY = 'django-insecure-i*juv#*#8@)azdxm4&ptkq4@tev587^@ygkvn)#koqe!az-@a!'
...
WSGI_APPLICATION = 'haasa.wsgi.application'
